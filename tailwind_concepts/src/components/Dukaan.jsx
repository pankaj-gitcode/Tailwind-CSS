...
export default function Dukaan(){
    return(
        <>
            <div className=' flex items-center justify-between sticky w-full  px-2  sm:px-8 py-5'>

                <div className='flex jsutify-between items-center sm:gap-4 gap-2'>
                            {/* --------------SIDE BAR ----------------- */}
                    <div className='bg-[#1E2640] text-[#fff] absolute left-0 top-0 h-[100vh] w-52 sm:block hidden'>
                ...
                <div className='bg-gray-100 flex items-center justify-between pl-2 pr-8 py-3 gap-2'>
                ...
                <div className=' flex items-center justify-between sm:gap-4 gap-2 '>
                    ...
                    <button className='bg-gray-300 sm:h-10 h-8 w-8 sm:w-10 p-2 rounded-full '>
                    ...
                    <button className='bg-gray-300 sm:h-10 h-8 w-8 sm:w-10 rounded-full sm:p-2 p-1 '>
